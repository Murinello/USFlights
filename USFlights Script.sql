...
SELECT Origin, 
AVG(DepDelay) AS 'Departure AVG delay:', 
AVG(ArrDelay) AS 'Arrival AVG delay:' 
FROM Flights 
GROUP BY 1 
ORDER BY 1;
...
Month AS 'Month', 
AVG(ArrDelay) 
AS 'Arrival AVG delay:' 
FROM USAirports 
JOIN Flights ON Flights.Origin=USAirports.IATA
GROUP BY 1, 2, 3 
ORDER BY 1, 2, 3;
